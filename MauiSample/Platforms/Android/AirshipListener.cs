...
{
    public class AirshipListener : Java.Lang.Object, IAirshipChannelListener, IPushTokenListener, IPushListener, INotificationListener
    {
        private const string TAG = "AirshipListener";
