...
namespace UrbanAirship {
	...
	*/
	...
	{
		// @required -(void)locationProvider:(id<UALocationProviderProtocol> _Nonnull)locationProvider withLocationManager:(CLLocationManager * _Nonnull)locationManager didChangeAuthorizationStatus:(CLAuthorizationStatus)status;
		[Abstract]
		[Export ("locationProvider:withLocationManager:didChangeAuthorizationStatus:")]
		void DidChangeAuthorizationStatus (UALocationProviderProtocol locationProvider, CLLocationManager locationManager, CLAuthorizationStatus status);

		// @required -(void)locationProvider:(id<UALocationProviderProtocol> _Nonnull)locationProvider withLocationManager:(CLLocationManager * _Nonnull)locationManager didFailWithError:(NSError * _Nonnull)error;
		[Abstract]
		[Export ("locationProvider:withLocationManager:didFailWithError:")]
		void DidFailWithError (UALocationProviderProtocol locationProvider, CLLocationManager locationManager, NSError error);

		// @required -(void)locationProvider:(id<UALocationProviderProtocol> _Nonnull)locationProvider withLocationManager:(CLLocationManager * _Nonnull)locationManager didUpdateLocations:(NSArray * _Nonnull)locations;
		[Abstract]
		[Export ("locationProvider:withLocationManager:didUpdateLocations:")]
		void DidUpdateLocations (UALocationProviderProtocol locationProvider, CLLocationManager locationManager, CLLocation[] locations);
	}

	// @protocol UALocationProviderProtocol <NSObject>
	[Protocol, Model]
	[BaseType (typeof(NSObject))]
	interface UALocationProviderProtocol
	{
		// @required @property (retain, nonatomic) CLLocationManager * _Nonnull locationManager;
		[Abstract]
		[Export ("locationManager", ArgumentSemantic.Retain)]
		CLLocationManager LocationManager { get; set; }

		// @required @property (assign, nonatomic) CLLocationDistance distanceFilter;
		[Abstract]
		[Export ("distanceFilter")]
		double DistanceFilter { get; set; }

		// @required @property (assign, nonatomic) CLLocationAccuracy desiredAccuracy;
		[Abstract]
		[Export ("desiredAccuracy")]
		double DesiredAccuracy { get; set; }

		// @required @property (assign, nonatomic) UALocationProviderStatus serviceStatus;
		[Abstract]
		[Export ("serviceStatus", ArgumentSemantic.Assign)]
		UALocationProviderStatus ServiceStatus { get; set; }

		// @required @property (copy, nonatomic) NSString * _Nonnull provider;
		[Abstract]
		[Export ("provider")]
		...
		// @required @property (assign, nonatomic) id _Nullable delegate;
		[Abstract]
		[NullAllowed, Export ("delegate", ArgumentSemantic.Assign)]
		NSObject WeakDelegate { get; set; }

		// @required -(NSString * _Nullable)purpose;
		[Abstract]
		[NullAllowed, Export ("purpose")]
		string Purpose ();

		// @required -(void)startReportingLocation;
		[Abstract]
		[Export ("startReportingLocation")]
		void StartReportingLocation ();

		// @required -(void)stopReportingLocation;
		[Abstract]
		[Export ("stopReportingLocation")]
