...
namespace UrbanAirship
{
	...
	// @interface UAPreferenceCenterResources : NSObject
	[BaseType(typeof(NSObject))]
	interface UAPreferenceCenterResources
	{
    ...
    // @interface UAPreferenceCenterViewController : UIViewController <UITableViewDataSource, UITableViewDelegate>
    [BaseType(typeof(UIViewController))]
	interface UAPreferenceCenterViewController : IUITableViewDataSource, IUITableViewDelegate
	{
		// @property (nonatomic, strong) UAPreferenceCenterStyle * _Nullable style;
		[NullAllowed, Export("style", ArgumentSemantic.Strong)]
		UAPreferenceCenterStyle Style { get; set; }
